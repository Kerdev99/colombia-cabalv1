    ...
    >
      <div className="bg-white bg-opacity-95 p-8 rounded-lg shadow-lg">
        <div className="mb-16 text-center">
          <h2 className="text-5xl font-bold tracking-tight text-primary mb-4 animate-float font-sketch">
            🌿 Colombia Cabal Cocaine (CCC) 🌿
          </h2>
          <p className="text-2xl text-text max-w-3xl mx-auto mb-4">
            What Wall Street absolutely loves, what every party desperately needs, powered by the beautiful nation of
            Colombia 🇨🇴
          </p>
          <p className="text-xl text-text max-w-3xl mx-auto mb-6">
            Our Official CA: coming soon
          </p>
          <Link
        ...
        <h3 className="text-3xl font-bold text-center mb-8 text-primary font-sketch">Meet Our Team</h3>
        ...
        <div className="mt-20 text-center">
          <h2 className="text-4xl font-bold tracking-tight text-primary mb-6 animate-pulse font-sketch">
